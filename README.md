...
```
![실행화면]([[demo.png](https://github.com/dae-you-kim/scm-factory-pareto/blob/main/demo.png)](https://github.com/dae-you-kim/scm-factory-pareto/blob/main/demo.png?raw=true))
```
